...
calcAndSave_simNull_pval <- function(GDRnullFile, pvalSaveFile) {
  ...
  P = ecdf(GDRnullData[,1])    # Returns function of empirical CDF
  p_val = P(GDR)               # Returns p val GDR
...
cat(c("group_size", "permutations", "GDR", "n_uniq_pvals", "pval"), file = save_file, append=TRUE)
