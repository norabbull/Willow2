...
DESCRIPTION: 
    ...
    Calculated simulated GDR values and plotting:
        
    - Plot: Simulated GDR values (figure 6.1)
    - Plot: p-values of dimulated GDR values (figure 6.2)
    - Plot: p-values of dimulated GDR values (figure 6.3)
...
GDRresults = pd.DataFrame(
    columns=['Group_size', 'Permutations', 'GDR', 'randomGDR'])
